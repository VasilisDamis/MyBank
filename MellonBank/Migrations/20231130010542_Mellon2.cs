...
{
    /// <inheritdoc />
    public partial class Mellon2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MellonnBankAccounts", x => x.AccountNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MellonnBankAccounts_AFM",
